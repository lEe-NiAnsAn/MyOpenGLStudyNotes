...
// 需要规定纹理图像名为形如：“texture_diffuse”+“n”、“texture_specular”+“n”，其中“n”为从1开始的编号，例："texture_diffuse1.png"
void Mesh::Draw(Shader &shader) {
    ...
    for(unsigned int i = 0; i < textures.size(); i++) {
        ...
        if(name == "texture_diffuse")
            ...
            number = std::to_string(specularNr++);					// 对漫反射纹理与镜面反射纹理分别计数
